...
import { Cloud, Code, Users, Sparkles, Server, Zap } from "lucide-react";
  ...
  const projects = [
    {
      ...
      description: "Built a scalable REST API using AWS Lambda, API Gateway, and DynamoDB. Handles 10,000+ requests per second with automatic scaling and fault tolerance.",
      technologies: ["AWS Lambda", "API Gateway", "DynamoDB", "Node.js"],
      gradient: ""
    },
    {
      title: "Cloud Infrastructure Automation",
      description: "Developed infrastructure-as-code solution using AWS CDK and CloudFormation. Automated deployment of multi-tier applications with CI/CD integration.",
      technologies: ["AWS CDK", "CloudFormation", "EC2", "S3", "Python"],
      gradient: ""
    },
    {
      title: "Real-time Data Pipeline",
      description: "Engineered real-time data processing pipeline using AWS Kinesis and Lambda. Processes and analyzes streaming data from IoT devices with sub-second latency.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-white text-slate-900 overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-6 py-20">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            Building the future with cloud technology. Join us to learn, innovate, and connect with fellow cloud enthusiasts.
          </motion.p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="relative bg-gradient-to-br from-white to-blue-50 backdrop-blur-sm p-12 rounded-3xl border border-blue-300 shadow-xl">
              ...
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-slate-900">Ready to Build the Future?</h2>
              <p className="text-xl text-slate-700 mb-8">
                Join us for workshops, hackathons, and cloud certification prep sessions.
              </p>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
